...
The biggest single drop is lead to deal (nearly 90% of leads never convert),
but the more actionable gap is the **462 sellers who signed and never sold
anything**, which is 55% of onboarded sellers. That's an onboarding problem,
...
at 11.8% to 16.3%. Email (3.0%) and "other" (2.7%) are the weakest channels,
...
convert from signed to selling at 57% to 64%, versus `food_supplement` and
